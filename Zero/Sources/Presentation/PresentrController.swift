...
extension PresentrController {
    ...
    func swipeGestureChanged(gesture: UIPanGestureRecognizer) {
        ...
        let swipeBottom: Bool = (dismissOnSwipeDirection == .default) ? presentationType != .popup : dismissOnSwipeDirection == .bottom
        let swipeTop: Bool = (dismissOnSwipeDirection == .default) ? presentationType == .popup : dismissOnSwipeDirection == .top
