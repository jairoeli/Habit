...
struct PresentrTransitionContext {
...
class PresentrAnimation: NSObject {
    ...
    func beforeAnimation(using transitionContext: PresentrTransitionContext) {
    ...
    ///
    /// - Parameter transitionContext: The context with everything needed for the animiation.
    func performAnimation(using transitionContext: PresentrTransitionContext) {
        let finalFrameForVC = transitionContext.finalFrame
        let initialFrameForVC = transform(containerFrame: transitionContext.containerView.frame, finalFrame: finalFrameForVC)
    ...
    ///
    /// - Parameter transitionContext: The context with everything needed for the animiation.
    func afterAnimation(using transitionContext: PresentrTransitionContext) {
